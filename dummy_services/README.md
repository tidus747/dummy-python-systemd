...
Aside from this `README.md` file, this repository contains a basic implementation of a Python service consisting of a Python script (`python_dummy_service.py`) and a systemd unit file (`python_dummy_service.service`).
